...
insert into restaurant values(null,'코토코토',null, '서울 도봉구 노해로69길 26','0507-1358-6008','월 ~ 금 - 11:00 ~ 21:00 (20:30 라스트오더), 토 - 11:00 ~ 20:00 (19:30 라스트오더), 일 - 정기휴무 (매주 일요일)) ');
insert into restaurant values(null,'철수는 부대찌개 영희는 김치찌개 창동역점','김치찌개 부대찌개 돌솥비빔밥 불고기백반 6900원
혼밥환영 가성비갑
안주메뉴 추가
짬뽕맛해물탕,불고기야채쌈,매콤찜닭', '서울 도봉구 노해로65길 7-12 1층','0507-1339-1504','매일 11:00 ~ 22:30');
insert into restaurant values(null,'리얼파스타 창동점','안녕하세요 리얼파스타 창동점입니다 :)
...
insert into restaurant values(null,'마쯔무라돈가스 본점','저희 마쯔무라 돈가스전문점 창동본점은 1997년 8월 15일 개업하여 오늘에 이르기까지 고객의 꾸준한 사랑을 받으며 나날이 성장해 왔습니다. 진심으로 감사드리며 앞으로도 수익보다는 고객 한 분 한 분들에게 만족을 느끼게 하는데 최선을 다할 것임을 약속합니다.
', '서울 도봉구 노해로63길 84 지하1층','02-990-9801','화 ~ 금 - 09:30 ~ 18:00, 토 09:30 ~ 16:00, 일 ~ 월 정기휴무');
insert into restaurant values(null,'국수나무 창동점','- 생면 전문점으로써 한식, 중식, 일식의 대표 면요리를 제공합니다.
돈까스,덮밥,면류등 모두가 맛있게 즐길수 있는 다양한 메뉴가 있습니다.', '서울 도봉구 노해로63가길 22 1층 102호','02-907-2333','월 ~ 토 - 11:00 ~ 21:00, 일 - 정기휴무 (매주 일요일)');
insert into restaurant values(null,'빽다방 창동역점','', '','','');
...
insert into Category VALUES(null, "분식", 5);
